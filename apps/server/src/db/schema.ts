...
export const sessionsTable = pgTable("sessions", {
  ...
  currentSelectedNodeId: uuid("current_selected_node_id"),
  lastExecutedTargetNodeId: uuid("last_executed_target_node_id"),
...
export const treeOperationsTable = pgTable("tree_operations", {
  ...
  affectedChildGroupId: uuid("affected_child_group_id"),
  insertedNodeIds: jsonb("inserted_node_ids").$type<string[]>().notNull(),
  deletedNodeIds: jsonb("deleted_node_ids").$type<string[]>().notNull(),
  ...
  undoOfOperationId: uuid("undo_of_operation_id"),
  redoOfOperationId: uuid("redo_of_operation_id"),
